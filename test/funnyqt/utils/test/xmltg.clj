...
(deftest test-example-with-dtd
  (let [g (xml2graph "test/input/xmltg-example-with-dtd.xml")]
    (is (== 123 (vcount g)))
...
(deftest test-example-with-dtd-and-IDREFS
  (let [g (xml2graph "test/input/xmltg-example-with-dtd-and-IDREFS.xml")]
    (asserts-for-idrefs-example g)))

(deftest test-example-without-dtd
  (let [g (xml2graph "test/input/xmltg-example-without-dtd.xml"
